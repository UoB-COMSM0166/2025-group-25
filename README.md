...
|Name | Image | Description |
| --------------------- | ------------- | ------------------- |
| **Rubbish** |<img src="docs/assets/rabbish.png" width="50" style="display:block; margin:0 auto;">| Collect 12 rubbish in each level to unlock the exit door and proceed to the next level or complete the stage. <br> |
