  ...
  levels = [
    {
      ...
      platforms: [//cailing
        ...
        { x: 1900, y: 550, w: 300, h: 50, type: "daae" },//1.7地面水洼左
        { x: 2650, y: 550, w: 800, h: 50, type: "daaaaaae" },//1.7地面水洼右（水洼间隔300正好极限跳过去，后面的关卡可以设置）


        { x: 5150, y: 410, w: 250, h: 100, type: "b" },//1.11
        { x: 4950, y: 480, w: 450, h: 100, type: "b" },//1.10
        { x: 4600, y: 550, w: 800, h: 50, type: "bb" },//1.8
       
        { x: 3650, y: 470, w: 300, h: 20, type: "c" },//1.9.1 长水洼平台1
        { x: 4120, y: 370, w: 300, h: 20, type: "c" },//1.9.2 长水洼平台2 (高度差90：一个巧妙地高度差，一段跳跃看似跳的上去，实则跳不上去）
        { x: 4300, y: 280, w: 300, h: 20, type: "c" },//1.9.2 长水洼平台3
        { x: 4500, y: 150, w: 300, h: 20, type: "c" },//1.9.2 长水洼平台2
        
      ],
      waterRegions: [  // 为此关卡添加水面区域kx~~~~~~~~
    ...
    
    {
      ...
      platforms: [//cailing
        ...
        { x: 4900, y: 320, w: 80, h: 400, type: "h" },
        { x: 5300, y: 320, w: 80, h: 400, type: "h" },
        { x: 5700, y: 320, w: 80, h: 400, type: "h" },
        { x: 6100, y: 320, w: 80, h: 400, type: "h" },

        { x: 6510, y: 240, w: 60, h: 700, type: "i" },
        { x: 6420, y: 240, w: 240, h: 40, type: "km" },//城堡
        
        { x: 6810, y: 440, w: 60, h: 700, type: "i" },
        { x: 6720, y: 440, w: 240, h: 40, type: "km" },//城堡
        ...
        { x: 7320, y: 440, w: 240, h: 40, type: "km" },//城堡  
    ...
    },
    {
      ...
      { x: 0, y: 400, w: 260, h: 8,type: "ooooooooooooooooo" },//2.1 开头平台
      { x: 259, y: 400, w: 5, h: 150, type: "o" },//2.1.right

      { x: 350, y: 400, w: 50, h: 8,type: "oooooo" },//2.3 小平台1 【两个间隙设置飞鸟】
      { x: 350, y: 400, w: 5, h: 20, type: "oo" },//2.3.left
      { x: 398, y: 400, w: 5, h: 20,type: "oo" },//2.3.right

      { x: 450, y: 400, w: 50, h: 8, type: "oooooo" },//2.4 小平台2 【空中设置金币】
      { x: 450, y: 400, w: 5, h: 20, type: "ooo" },//2.4.left
      { x: 498, y: 400, w: 5, h: 20, type: "oo" },//2.4.right

      { x: 550, y: 400, w: 50, h: 8 ,type: "ooooooo"},//2.5 小平台3
      { x: 550, y: 400, w: 5, h: 20, type: "oo" },//2.5.left
      { x: 598, y: 400, w: 5, h: 20, type: "oo" },//2.5.right

      { x: 700, y: 400, w: 5, h: 150,type: "oo" },//2.6.1 曲折大平台开始
      { x: 700, y: 400, w: 260, h: 8 ,type: "ooooooooooooooooooooooooooooooooooooooooooooooo"},//2.6.2
      { x: 958, y: 400, w: 5, h: 40,type: "ooooo" },//2.6.3
      { x: 958, y: 438, w: 170, h: 8,type: "ooooooooooooooooooooooooooooo" },//2.6.4 【设置金币】
      { x: 1125, y: 280, w: 5, h: 160,type: "oo" },//2.6.5
      { x: 1125, y: 280, w: 270, h: 8,type: "ooooooooooooooooooooooooooo" },//2.6.6 【设置螃蟹1.6.6~1.6.8之间移动】
      { x: 1393, y: 280, w: 5, h: 40,type: "oooooo" },//2.6.7
      { x: 1393, y: 318, w: 220, h: 8,type: "ooooooooooooooooooooooooooooo" },//2.6.8
      { x: 1613, y: 318, w: 5, h: 220, type: "oo" },//2.6.9

      { x: 1690, y: 180, w: 50, h: 8 ,type: "oooooooooo"},//2.7 小平台1
      { x: 1690, y: 180, w: 5, h: 20 ,type: "oo"},//2.7.left 
      { x: 1738, y: 180, w: 5, h: 20 , type: "oo"},//2.7.right

      { x: 1840, y: 100, w: 50, h: 8 , type: "ooooo"},//2.7 小平台2
      { x: 1840, y: 100, w: 5, h: 20 , type: "oo"},//2.7.left 
      { x: 1888, y: 100, w: 5, h: 20 , type: "oo"},//2.7.right

      // { x: 2100, y: 580, w: 50, h: 8,type: "oooooo" },
      // { x: 2160, y: 540, w: 5, h: 40 },//2.8 楼梯开始
      { x: 2160, y: 540, w: 50, h: 8,type: "oooooo" },//
      // { x: 2210, y: 500, w: 5, h: 45 },
      { x: 2210, y: 500, w: 50, h: 8 ,type: "oooooo"},
      // { x: 2258, y: 460, w: 5, h: 45 },
      { x: 2260, y: 460, w: 50, h: 8 ,type: "oooooo"},
      // { x: 2310, y: 422, w: 5, h: 45 },
      { x: 2310, y: 420, w: 50, h: 8 ,type: "oooooo"},
      // { x: 2360, y: 382, w: 5, h: 45 },
      { x: 2360, y: 380, w: 50, h: 8 ,type: "oooooo"},
      // { x: 2410, y: 342, w: 5, h: 45 },
      { x: 2410, y: 340, w: 200, h: 8, type: "oooooooooooooooooooooooo" },
      // { x: 2610, y: 300, w: 5, h: 45 },

      // { x: 2610, y: 300, w: 50, h: 8 , type: "oooooo"},//2.9 二段向上楼梯
      { x: 2660, y: 260, w: 50, h: 8 , type: "oooooo"},
      { x: 2710, y: 220, w: 50, h: 8 , type: "oooooo"},
      { x: 2760, y: 180, w: 50, h: 8 , type: "oooooo"},
      { x: 2810, y: 140, w: 50, h: 8 , type: "oooooo"},
      { x: 2860, y: 100, w: 500, h: 8 , type: "ooooooooooooooooooooooooooooooooooooooooooo"},

      { x: 2610, y: 380, w: 50, h: 8 , type: "oooooo"},//2.10 二段向下楼梯【右上空中放置金币】
      { x: 2660, y: 420, w: 50, h: 8 , type: "oooooo"},
      { x: 2710, y: 460, w: 50, h: 8 , type: "oooooo"},
      { x: 2760, y: 500, w: 50, h: 8 , type: "oooooo"},
      { x: 2810, y: 540, w: 300, h: 15 , type: "oooooooooooooooooooooooooooooooo"},
      ...
      { x: 4450, y: 400, w: 350, h: 20, type: "oooooooooooooooooooooooooooooooooooooooooooo" },//传送门平台
      ],
      items: [
    ...
    },
    {
      ...
      platforms: [
        ...
        { x: 980, y: 260, w: 50, h: 50, type: "u" },   // 小方块横
        { x: 1320, y: 260, w: 50, h: 50, type: "u" },   // 小方块横
        { x: 1660, y: 260, w: 50, h: 50 , type: "u"},   // 小方块横
        ...
        { x: 4100, y: 400, w: 80, h: 50, type: "u" },   // 小方块1
        { x: 4250, y: 350, w: 80, h: 50, type: "u" },   // 小方块2
        { x: 4400, y: 300, w: 80, h: 50 , type: "u"},   // 小方块3
        { x: 4550, y: 250, w: 80, h: 50, type: "u" },   // 小方块4
        { x: 4800, y: 200, w: 400, h: 20 , type: "uuu"},  // 最终平台（传送门位置）
      ],
      items: [
